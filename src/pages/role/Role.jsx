        ...
        <div className="table-container">
            <Spin spinning={loading}>
                <Modal
                    destroyOnClose={true}
                    open={open}
                    title={detailData.id ? 'Cập nhật nhóm quyền' : 'Thêm mới nhóm quyền'}
                    onCancel={handleCancel}
                    footer={[]}
                    width="1000px"
                >
                    <CreateOrEditRole getRoleList={getRoleList} close={handleCancel} detailData={detailData} />
                </Modal>
