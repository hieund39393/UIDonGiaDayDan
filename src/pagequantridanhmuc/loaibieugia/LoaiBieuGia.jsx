...
import CreateOrEditLoaiBieuGia from './CreateOrEditLoaiBieuGia';
import { permission } from '~/permissions/index';
import CheckPermission from '~/components/CheckPermission';

export default function LoaiBieuGia() {
    ...
    // Get List LoaiBieuGia
    const getLoaiBieuGiaList = useCallback(() => {
        const query = buildQueryString(filterConditions);
        authGetData({
            url: `${Endpoint.CRUD_LOAIBIEUGIA}?${query}`,
            setLoading,
            onSuccess: (res) => {
    ...
    const handleDelete = useCallback((id) => {
        authDeleteData({
            url: `${Endpoint.CRUD_LOAIBIEUGIA}/${id}`,
            setLoading,
            onSuccess: () => {
                getLoaiBieuGiaList();
            },
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) => (
                <div>
                    <CheckPermission permissionCode={permission.p_loaibieugia_sua}>
                    ...
                    <CheckPermission permissionCode={permission.p_loaibieugia_xoa}>
        ...
        <div className="table-container">
            <Spin spinning={loading}>
                <Modal
                    ...
                    width="800px"
                >
                    <CreateOrEditLoaiBieuGia
                        getLoaiBieuGiaList={getLoaiBieuGiaList}
                        close={handleCancel}
