...
import CreateOrEditCongViec from './CreateOrEditCongViec';
...
export default function CongViec() {
    ...
    // Get List CongViec
    const getCongViecList = useCallback(() => {
        const query = buildQueryString(filterConditions);
        authGetData({
            url: `${Endpoint.CRUD_CONGVIEC}?${query}`,
            setLoading,
            onSuccess: (res) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) => (
                <div>
                    <CheckPermission permissionCode={permission.p_congviec_sua}>
                    ...
                    <CheckPermission permissionCode={permission.p_congviec_xoa}>
        ...
        <div className="table-container">
            <Spin spinning={loading}>
                <Modal
                    ...
                    width="800px"
                >
                    <CreateOrEditCongViec
                        getCongViecList={getCongViecList}
                        close={handleCancel}
