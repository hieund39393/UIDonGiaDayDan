...
import CreateOrEditKhuVuc from './CreateOrEditKhuVuc';
...
export default function KhuVuc() {
    ...
    // Get List KhuVuc
    const getKhuVucList = useCallback(() => {
        const query = buildQueryString(filterConditions);
        authGetData({
            url: `${Endpoint.CRUD_KHUVUC}?${query}`,
            setLoading,
            onSuccess: (res) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (row) => (
                <div>
                    <CheckPermission permissionCode={permission.p_khuvuc_sua}>
                    ...
                    <CheckPermission permissionCode={permission.p_khuvuc_xoa}>
        ...
        <div className="table-container">
            <Spin spinning={loading}>
                <Modal
                    ...
                    width="800px"
                >
                    <CreateOrEditKhuVuc getKhuVucList={getKhuVucList} close={handleCancel} detailData={detailData} />
                </Modal>
